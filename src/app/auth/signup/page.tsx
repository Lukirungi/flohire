      ...
      <div style={{ background: 'var(--flo-ink)', padding: '60px 64px', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative' }}>
          ...
          <p style={{ fontSize: '15px', color: 'rgba(255,255,255,.45)', lineHeight: 1.65, marginBottom: '32px' }}>
            From browsing to a live automation running in your business — most orders complete in under 2 weeks.
          </p>
      ...
      <div style={{ padding: '60px 64px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--flo-white)' }}>
        <div style={{ width: '100%', maxWidth: '380px' }}>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <input type="text" placeholder="Your name" style={{ width: '100%', padding: '10px 14px', border: '1.5px solid var(--flo-border)', borderRadius: '6px', fontSize: '14px', fontFamily: 'var(--font-body)', outline: 'none' }} />
          </div>
          <div style={{ marginBottom: '16px' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <input type="password" placeholder="At least 8 characters" style={{ width: '100%', padding: '10px 14px', border: '1.5px solid var(--flo-border)', borderRadius: '6px', fontSize: '14px', fontFamily: 'var(--font-body)', outline: 'none' }} />
          </div>
